      ...
      >
        <div className="p-8 rounded-xl border" style={{ backgroundColor: 'var(--bg-elevated)', borderColor: 'var(--border-subtle)' }}>
          ...
          <p className="mb-8 max-w-3xl mx-auto" style={{ color: 'var(--fg-secondary)' }}>
            Enterprise-validated performance metrics demonstrating production readiness 
            and scalability of FileHawk's mathematical intelligence engine.
          </p>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { metric: '95.7%', label: 'Natural Language Understanding', description: 'Measured across 1000+ diverse queries' },
              { metric: '<50ms', label: 'Algorithm Latency', description: 'Including confidence computation and ranking' },
          ...
          <div className="text-sm text-brand-gold-400">
            Validated through comprehensive semantic clustering, natural language tolerance, and confidence calibration testing
          </div>
        </div>
      </motion.section>
    </div>
